...
<body>
    <div class="container">
		...
		if ($_SERVER["REQUEST_METHOD"] == "POST") {
			...
			$total_a_pagar = ($valor_compra + $gorjeta) * $qualidade_servico;		
			$valor_qualidade_servico = ($total_a_pagar - $gorjeta) - ($valor_compra * $qualidade_servico);
				
			
			
			echo "<div class='resumo'>";
			echo "<h3>Resumo da Gorjeta</h3>";
			echo "<p><strong>Valor da Conta:</strong> R$ " . number_format($valor_compra, 2, ',', '.') . "</p>";
			echo "<p><strong>Porcentagem de Gorjeta:</strong> " . ($porcentagem_gorjeta * 100) . "%</p>";
